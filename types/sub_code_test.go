...
func TestSubCodeToString(t *testing.T) {
	cases := []struct {
		...
		{"op regex limit pair", types.OP_NOT_APPLICABLE, types.SubCodeOpNotStringRegexLimitExceeded, "SubCodeOpNotStringRegexLimitExceeded"},
		{"highest declared op pair", types.OP_NOT_APPLICABLE, types.SubCodeOpNotStringB64Invalid, "SubCodeOpNotStringB64Invalid"},
		{"undeclared op subcode", types.OP_NOT_APPLICABLE, 14, "SubCode(26/14)"},
