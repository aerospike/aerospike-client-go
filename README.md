...
[![Aerospike Client Go](https://goreportcard.com/badge/github.com/KeanuRo/aerospike-client-go)](https://goreportcard.com/report/github.com/KeanuRo/aerospike-client-go)
...
[![Godoc](https://godoc.org/github.com/KeanuRo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/KeanuRo/aerospike-client-go)

## IMPORTANT NOTE

This is an old version the _Aerospike Go Client_, which is v4.x.x. The newest version _v5_ has migrated to _go modules_,
which required us to put it in the `v5` branch [here](https://github.com/KeanuRo/aerospike-client-go/tree/v5).
All the latest changes to the library are applied in that branch, documented in the [CHANGELOG](https://github.com/KeanuRo/aerospike-client-go/blob/v5/CHANGELOG.md).
...
Up-to-date documentation is available in the [![Godoc](https://godoc.org/github.com/KeanuRo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/KeanuRo/aerospike-client-go).
...
import (
  ...
  aero "github.com/KeanuRo/aerospike-client-go"
)
...
2. Get the client in your ```GOPATH``` : ```go get github.com/KeanuRo/aerospike-client-go```
  * To update the client library: ```go get -u github.com/KeanuRo/aerospike-client-go```
...
A simple API documentation is available in the [`docs`](docs/README.md) directory. The latest up-to-date docs can be found in [![Godoc](https://godoc.org/github.com/KeanuRo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/KeanuRo/aerospike-client-go).
