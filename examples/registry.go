...
var examples = []Example{
	...
	{Name: "operate_string_read", Run: runOperateStringRead, Fixture: fixtures.OperateStringRead(),
		Requires: MinServerVersionPatch(8, 1, 3)},
	{Name: "operate_string_modify", Run: runOperateStringModify, Fixture: fixtures.OperateStringModify(),
		Requires: MinServerVersionPatch(8, 1, 3)},
	{Name: "operate_string_tostring", Run: runOperateStringToString, Fixture: fixtures.OperateStringToString(),
		Requires: MinServerVersionPatch(8, 1, 3)},
